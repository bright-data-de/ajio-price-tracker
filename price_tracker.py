...
Info  : https://brightdata.de/products/insights/price-tracker/ajio
"""
...
# https://brightdata.de/products/web-scraper/ajio
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your AJIO scraper at: https://brightdata.de/products/web-scraper/ajio\n"
